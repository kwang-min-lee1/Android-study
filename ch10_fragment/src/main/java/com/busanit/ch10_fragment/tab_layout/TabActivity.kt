...
import com.busanit.ch10_fragment.pager.FragmentOne1
...
class TabActivity : AppCompatActivity() {
    ...
    // 뷰 페이저 어댑터 클래스
    class TabAdapter(fragmentActivity: FragmentActivity, val fragmentList:
    MutableList<Fragment>) : FragmentStateAdapter(fragmentActivity) {
